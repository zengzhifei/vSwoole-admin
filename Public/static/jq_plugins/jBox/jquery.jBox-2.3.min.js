(function(a) {
	a.jBox = function(b, c) {
		...
		j.push('<div class="jbox-help-button jbox-button-panel" style="height:40px;padding:5px 0 5px 0;display:none;"></div>');
		...
		if (g) {
			...
			j.push('<div class="jbox-title' + (c.showIcon == true ? ' jbox-title-icon' : (c.showIcon == false ? '' : ' ' + c.showIcon)) + '" style="float:left; line-height:34px;font-family:'+ "Open Sans"+',sans-serif;font-weight: 300; padding-left:' + (c.showIcon ? 0x12 : 0x5) + 'px;overflow:hidden;text-overflow:ellipsis;word-break:break-all;">' + (c.title == '' ? '&nbsp;' : c.title) + '</div>');
		...
		a.each(b, function(N, O) {
			...
			r.push('<div class="jbox-button-panel" style="height:40px;padding:5px 0 30px 0;text-align: right;' + (P ? '' : 'display:none;') + '">');
			if (!c.isTip) {
