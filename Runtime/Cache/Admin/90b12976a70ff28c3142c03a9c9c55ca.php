                                    ...
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2" style="margin-right:100px;">
                                                <input type="text" placeholder="请输入栏目名称关键字" name="find_column_name" class="form-control input-medium search-input" value="<?php echo ($data['pageFind']['stage_name']); ?>">
                                            </div>
                                            <div class="col-md-2">
                            ...
                            <div class="portlet-body">
                                ...
                                <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                    ...
                                    <?php if(!empty($data['pageInfo'])): if(is_array($data['pageInfo'])): foreach($data['pageInfo'] as $key=>$vo): ?><tr>
                                                ...
                                                <td style="width:15%;"><?php echo ($vo["column_id"]); ?></td>
                                                <td style="width:10%;"><?php echo ($vo["column_name"]); ?></td>
                                                <td style="width:10%;"><?php echo (date("Y-m-d",$vo["column_created"])); ?></td>
                                                <td style="width:50%;"><?php echo ($vo["column_remark"]); ?></td>
                                                <td style="width:10%;">
                                                    <?php if($vo["column_status"] == 0): ?><a><i column_id="<?php echo ($vo["column_id"]); ?>" column_status="1" class="glyphicon glyphicon-play column-switch" title="点击开启当前期"></i></a>
                                                    <?php else: ?>
                                                        <a><i column_id="<?php echo ($vo["column_id"]); ?>" column_status="0" class="glyphicon glyphicon-stop column-switch" title="点击关闭当前期"></i></a><?php endif; ?>&nbsp;&nbsp;
                                                    <a><i column_id="<?php echo ($vo["column_id"]); ?>" class="glyphicon glyphicon-edit column-edit" title="编辑"></i></a>&nbsp;&nbsp;
                                                    <a><i column_id="<?php echo ($vo["column_id"]); ?>" class="glyphicon glyphicon-wrench column-maintenance" title="维护数据"></i></a>&nbsp;&nbsp;
                                                    <a><i column_id="<?php echo ($vo["column_id"]); ?>" column_status="<?php echo ($vo["column_status"]); ?>" class="glyphicon glyphicon-trash column-delete" title="删除"></i></a>
                                                </td>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#column-add").on('click', function () {
            var url = "<?php echo U('Column/addEdit');?>";
            ...
            $.confirm({
                ...
                buttons: {
                    "确定": {
                        ...
                        action: function () {
                            $.ajax({
                                url: "<?php echo U('Column/switchColumn');?>",
                                type: 'POST',
                                dataType: 'JSON',
                                data: data,
                                timeout: 20000,
        ...
        $(".column-maintenance").on('click', function () {
            var column_id = $(this).attr('column_id');
            var url = "<?php echo U('Stage/index');?>" + '&column_id=' + column_id;
            window.location.href = url;
        })
        //删除
            ...
            $.confirm({
                ...
                buttons: {
                    "确定": {
                        ...
                        action: function () {
                            $.ajax({
                                url: "<?php echo U('Column/deleteColumn');?>",
                                type: 'GET',
        ...
        $("#stage-search").on('click', function () {
            ...
            var url = "<?php echo U('Column/index');?>";
