                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <select class="form-control input-inline input-small" name="group-select-type">
                                                    <option value="1" <?php if($data['pageInfo']['group_type'] == '1'): ?>selected<?php endif; ?> >问答环节</option>
                                                    <option value="2" <?php if($data['pageInfo']['group_type'] == '2'): ?>selected<?php endif; ?> >抢答环节</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="group-title" value="<?php echo ($data['pageInfo']['group_title']); ?>" class="form-control input-inline input-medium" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3">分组时区<span class="required"> &nbsp; </span></label>
                                            <div class="col-md-9">
                                                <input type="text" name="dateRangePicker" value="<?php echo ($data['pageInfo']['group_time']); ?>" class="form-control input-inline input-large"  placeholder="分组时间区间"  readonly />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3">备注<span class="required"> &nbsp; </span></label>
                                            <div class="col-md-9">
                                                <textarea name="group-remark" class="form-control input-inline input-medium" rows="3"><?php echo ($data['pageInfo']['group_remark']); ?></textarea>
                                            </div>
                                        </div>
                                        <?php if(!empty($data["pageInfo"])): ?><input type="hidden" name="group-id" value="<?php echo ($data['pageInfo']['id']); ?>" />
                                            <input type="hidden" name="group-created" value="<?php echo ($data['pageInfo']['group_created']); ?>" /><?php endif; ?>
                                    </div>
...
<script>
    $(function () {
        ...
        $("#group-submit").on('click',function () {
            var data = {
                stage_id: "<?php echo ($data['pageParam']['stage_id']); ?>",
            ...
            $.ajax({
                url: "<?php echo U('Group/saveGroup');?>",
                type: 'POST',
                dataType: 'JSON',
                data: data,
                context: this,
                        ...
                        $.confirm({
                            ...
                            buttons: {
                                "确定": {
                                    class:"blue",
                                    action:function() {
                                        window.location.href = "<?php echo U('Column/index');?>";
                                    }
                                }
                            }
                        })
