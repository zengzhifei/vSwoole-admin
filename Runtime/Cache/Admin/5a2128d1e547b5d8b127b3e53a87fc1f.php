										...
										<div class="col-md-12">
											<form id="sortform" class="form-horizontal">
												<div class="form-group">
													...
													<div class="col-md-9">
														<input type="text" name="column-name" value="<?php echo ($data['pageInfo']['column_name']); ?>" maxlength="64" class="form-control input-inline input-medium"/>
													</div>
												</div>
										<!-- 		<div class="form-group">
													...
													<div class="col-md-9">
														<div class="input-group date date-picker" data-date-format="yyyy-mm-dd" data-date-start-date="+0d">
															<?php if(empty($data['pageInfo'])): ?><input type="text" name="column-date" readonly class="form-control input-inline input-medium"/>
															<?php else: ?>
																<input type="text" name="column-date" value="<?php echo (date('Y-m-d',$data['pageInfo']['column_date'])); ?>" readonly class="form-control input-inline input-medium"/><?php endif; ?>
												...
												<div class="form-group">
													...
													<div class="col-md-9">
														<textarea name="column-remark" cols="40" rows="4" maxlength="120" class="form-control input-inline input-medium"><?php echo ($data['pageInfo']['column_remark']); ?></textarea>
													</div>
												</div>
												<?php if(!empty($data['pageInfo'])): ?><input type="hidden" name="column-id" value="<?php echo ($data['pageInfo']['column_id']); ?>" />
													<input type="hidden" name="column-created" value="<?php echo ($data['pageInfo']['column_created']); ?>" /><?php endif; ?>
                            ...
                            $("#save-form").on('click',function () {
                              ...
                              /*  if (data.column_date.replace(/\s+/g, "").length === 0) {
								...
								*/
                                ...
                                $.ajax({
                                    url: "<?php echo U('Column/saveColumn');?>",
                                    type: 'POST',
                                    dataType: 'JSON',
                                    data: data,
                                    context: this,
