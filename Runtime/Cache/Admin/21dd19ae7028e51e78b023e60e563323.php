                                ...
                                <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                    ...
                                    <tr>
                                        ...
                                        <td style="float: left;">
                                            ...
                                            <button class="btn blue" type="button" qa-clear-key="<?php echo ($data['QA_CLEAR_DATA']); ?>" id="qa-clear-cache-data">确定</button>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>APP ID接口验证</td>
                                        <td style="float: left;">
                                            <input type="checkbox" config-key="CHECK_APP_USER_ID" config-val="<?php echo ($data['CHECK_APP_USER_ID']); ?>" class="switch" checked/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>短信通知手机号</td>
                                        <td style="float: left;">
                                            <input type="text" name="qa-sms-phones" class="form-control input-large" value="<?php echo ($data['QA_SMS_PHONES']); ?>" placeholder="多个手机号以英文','隔开" style="display: inline-block;">
                                    ...
                                    <tr>
                                        <td>系统异常短信通知</td>
                                        <td style="float: left;">
                                            <input type="checkbox" config-key="QA_SMS_NOTICE" config-val="<?php echo ($data['QA_SMS_NOTICE']); ?>" class="switch" checked/>
                                            <span>(剩余条数：<?php echo ($data['QA_SMS_TOTAL']); ?>)</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>定时服务器项目地址</td>
                                        <td style="float: left;">
                                            <input type="text" name="qa-server-path" class="form-control input-large" value="<?php echo ($data['QA_SERVER_TIME_PATH']); ?>" placeholder="以项目名结尾" style="display: inline-block;">
                                            <button class="btn blue" type="button" qa-server-type="<?php echo ($data['QA_SERVER_TIME']); ?>" id="set-server-path">确定</button>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>系统偏移量设置</td>
                                        <td style="float: left;">
                                            <input type="text" name="qa-push-offset" class="form-control input-small" value="<?php echo ($data['QA_PUSH_OFFSET']); ?>" placeholder="整秒数" style="display: inline-block;">
                                    ...
                                    <tr>
                                        <td>期参与人数基数设置</td>
                                        <td style="float: left;">
                                            <span><?php echo ($column['column_name']); ?>-<?php echo ($stage['stage_name']); ?>：</span>
                                            <input type="text" name="qa-stage-user-base-number" class="form-control input-small" value="<?php echo ($data['QA_STAGE_USER_JOIN_BASE']); ?>" placeholder="整数" style="display: inline-block;">
                                            <button class="btn blue" type="button" stage_id="<?php echo ($stage['stage_id']); ?>" id="set-qa-stage-user-base">确定</button>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>轮参与人数基数设置</td>
                                        <td style="float: left;">
                                            ...
                                            <select class="form-control input-inline input-small" name="qa-set-group-user-base-select-group">
                                                ...
                                                <?php if(is_array($group)): foreach($group as $key=>$item): ?><option value="<?php echo ($item["id"]); ?>"><?php echo ($item["group_title"]); ?></option><?php endforeach; endif; ?>
                                            </select>：
                                    ...
                                    <tr>
                                        ...
                                        <td style="float: left;">
                                            ...
                                            <button class="btn blue" type="button" stage_id="<?php echo ($stage['stage_id']); ?>" id="checkQaTime">确定</button>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
    ...
    $(function () {
        ...
        $(".switch").bootstrapSwitch({
            ...
            onSwitchChange: function (e, data) {
                ...
                var config_val = data;
                $.ajax({
                    url: "<?php echo U('QaConfig/setConfig');?>",
                    type: 'POST',
        ...
        $("#setQaPushOffsetByHand,#setQaPushOffsetByAuto").on('click', function () {
            ...
            $.ajax({
                url: "<?php echo U('QaConfig/setQaPushOffset');?>",
        ...
        $("#set-qa-stage-user-base").on('click', function () {
            ...
            $.ajax({
                url: "<?php echo U('QaConfig/setStageUserBaseNumber');?>",
        ...
        $("#set-qa-group-user-base").on('click', function () {
            ...
            $.ajax({
                url: "<?php echo U('QaConfig/setGroupUserBaseNumber');?>",
        ...
        $("select[name='qa-set-group-user-base-select-group']").on('change', function () {
            ...
            $.ajax({
                url: "<?php echo U('QaConfig/getGroupUserBaseNumber');?>",
        ...
        $("#checkQaTime").on('click', function () {
            ...
            if (stage_id && start_time && end_time) {
                $.ajax({
                    url: "<?php echo U('QaConfig/setQaTimeCheck');?>",
        ...
        $("#set-server-path").on('click', function () {
            ...
            if (server_type && server_path) {
                $.ajax({
                    url: "<?php echo U('QaConfig/setQaServerPath');?>",
        ...
        $("#set-sms-phones").on('click', function () {
            ...
            if (sms_phones) {
                $.ajax({
                    url: "<?php echo U('QaConfig/setQaSmsPhones');?>",
            ...
            $.confirm({
                ...
                buttons: {
                    "确定": {
                        ...
                        action:function () {
                            $.ajax({
                                url: "<?php echo U('QaConfig/clearCacheData');?>",
