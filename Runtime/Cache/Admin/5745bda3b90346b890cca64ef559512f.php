                        ...
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-body">
                                ...
                                <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                    ...
                                    <tbody>
                                    <?php if(!empty($process_list)): if(is_array($process_list)): foreach($process_list as $key=>$vo): ?><tr>
                                                <td><?php echo ($vo["project_name"]); ?></td>
                                                <td><?php echo ($vo["project_path"]); ?></td>
                                                <td><?php echo ($vo["process_name"]); ?></td>
                                                <td><?php echo ($vo["process_code"]); ?></td>
                                                <td>
                                                    <input type="checkbox" config-key="<?php echo ($vo["id"]); ?>" config-val="<?php echo ($vo["monitor_status"]); ?>" class="switch" checked/>
                                                </td>
                                                <td><a><i process_id="<?php echo ($vo["id"]); ?>" class="glyphicon glyphicon-trash monitor-process-delete" title="删除"></i></a></td>
    ...
    $(function () {
        ...
        $("#qa-monitor-process-add").on('click', function () {
            var options = {
                ...
                submit: function () {
                    ...
                    $.ajax({
                        url: "<?php echo U('QaMonitor/processAdd');?>",
                        type: 'GET',
                        data: data,
                        dataType: 'json',
        ...
        $(".switch").bootstrapSwitch({
            ...
            onSwitchChange: function (e, data) {
                ...
                $.ajax({
                    url: "<?php echo U('QaMonitor/processStartStop');?>",
                    type: 'POST',
        ...
        $(".monitor-process-delete").on('click',function () {
            ...
            $.ajax({
                url: "<?php echo U('QaMonitor/processDelete');?>",
                type: 'GET',
