                                ...
                                <form role="form" class="form-horizontal">
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-1">
                                                <button class="btn blue" type="button" column_id="<?php echo ($column_id); ?>" stage_id="<?php echo ($stage_id); ?>" group_id="<?php echo ($group_id); ?>" id="qa-lucky-list-create">生成</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                        ...
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-body">
                                ...
                                <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                    ...
                                    <tbody>
                                    <?php if(!empty($lucky_user_list)): if(is_array($lucky_user_list)): foreach($lucky_user_list as $key=>$vo): ?><tr>
                                                <td><input type="checkbox" id="<?php echo ($vo["id"]); ?>" class="select"></td>
                                                <td><?php echo ($p * 15 - 15 + $key + 1); ?></td>
                                                <td><?php echo ($vo["user_ranking"]); ?></td>
                                                <td>
                                                    <?php if($vo["user_head"] != ''): ?><img src="<?php echo ($vo["user_head"]); ?>" style="width: 50px;height: 50px;"><?php endif; ?>
                                                </td>
                                                ...
                                                <td>
                                                    <?php if($vo["user_status"] == 1): ?><span style="color: red;">已确认</span>
                                                        <?php else: ?>
                                                        未确认<?php endif; ?>
                                                </td>
                                                <td>
                                                    <?php if($vo["user_lucky_status"] == 1): ?><span style="color: red;">已领取</span>
                                                        <?php else: ?>
                                                        未领取<?php endif; ?>
                                                </td>
                                                <td>
                                                    <a><i lucky_id="<?php echo ($vo["id"]); ?>" class="glyphicon glyphicon-trash qa-lucky-list-delete" title="删除"></i></a>
                                                </td>
    ...
    $(function () {
        ...
        $("input[name='qa-lucky-list-type']").on('change', function () {
            ...
            switch (parseInt(qa_lucky_list_type)) {
                case 1:
                    var url = "<?php echo U('QaLucky/index');?>" + "&qa_lucky_list_type=" + qa_lucky_list_type + "&group_id=" + group_id;
                    break;
                case 2:
                    var url = "<?php echo U('QaLucky/index');?>" + "&qa_lucky_list_type=" + qa_lucky_list_type + "&stage_id=" + stage_id;
                    break;
                case 3:
                    var url = "<?php echo U('QaLucky/index');?>" + "&qa_lucky_list_type=" + qa_lucky_list_type + "&column_id=" + column_id;
                    break;
                default:
                    var url = "<?php echo U('QaLucky/index');?>";
                    break;
            }
            location.href = url;
        })
            ...
            $.confirm({
                ...
                buttons: {
                    "确定": {
                        ...
                        "action": function () {
                            $.ajax({
                                url: "<?php echo U('QaLucky/deleteLuckyUser');?>",
                                type: 'post',
        ...
        $("#qa-lucky-list-create").on('click', function () {
            ...
            $.ajax({
                url: "<?php echo U('QaLucky/luckyListCreate');?>",
                type: 'GET',
            ...
            $.confirm({
                ...
                buttons: {
                    "确定": {
                        ...
                        action: function () {
                            $.ajax({
                                url: "<?php echo U('QaLucky/syncQaLuckyUserList');?>",
                                type: 'GET',
        ...
        $("#qa-lucky-list-export").on('click', function () {
            var qa_lucky_list_type = "<?php echo ($qa_lucky_list_type); ?>";
            var group_id = "<?php echo ($group_id); ?>";
            var stage_id = "<?php echo ($stage_id); ?>";
            var column_id = "<?php echo ($column_id); ?>";
            switch (parseInt(qa_lucky_list_type)) {
                case 1:
                    var url = "<?php echo U('QaLucky/exportQaLuckyUserList');?>" + "&qa_lucky_list_type=" + qa_lucky_list_type + "&group_id=" + group_id;
                    break;
                case 2:
                    var url = "<?php echo U('QaLucky/exportQaLuckyUserList');?>" + "&qa_lucky_list_type=" + qa_lucky_list_type + "&stage_id=" + stage_id;
                    break;
                case 3:
                    var url = "<?php echo U('QaLucky/exportQaLuckyUserList');?>" + "&qa_lucky_list_type=" + qa_lucky_list_type + "&column_id=" + column_id;
                    break;
                default:
                    var url = "<?php echo U('QaLucky/index');?>";
                    break;
